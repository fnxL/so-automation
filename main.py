...
class AutomationToolGUI:
  def __init__(self, master):
    ...
    self.so_customers = list(CUSTOMER_CONFIGS.keys())  # Dynamically get customer list
  ...
  def run_automation(self):
    ...
    self.log_message(f"Initiating automation for customer: {selected_customer}", "info")
    ...
    self.automation_thread = threading.Thread(
      target=self._perform_automation_task, args=(selected_customer, source_folder)
    )
