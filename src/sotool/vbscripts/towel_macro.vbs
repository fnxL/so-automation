...
Private Const COL_STAKE_HOLDER As Integer = 35
Private Const COL_MATERIAL As Integer = 19
Private Const COL_QUANTITY As Integer = 20
Private Const COL_TT_SORT_NO As Integer = 22
Private Const COL_TT_SHADE As Integer = 23
Private Const COL_TT_SET_TYPE As Integer = 24
Private Const COL_EMB_CODE As Integer = 25
Private Const COL_SUBLISTATIC_CODE As Integer = 26
Private Const COL_TT_S_PART As Integer = 27
Private Const COL_TT_F_PART As Integer = 28
Private Const COL_DESTINATION As Integer = 29
Private Const COL_YD_MATCHING As Integer = 30
...
Private Const COL_PO_FILENAME As Integer = 37
...
Private Sub CreateNewSaleOrder(ByVal headerRow as Long)
    ...
    session.findById("wnd[0]/usr/tabsTAXI_TABSTRIP_OVERVIEW/tabpT\08/ssubSUBSCREEN_BODY:SAPMV45A:7901/cmbRV45A-MUEBS").Key = "ZVC_TT_V"
    ...
    ' Press Enter
    Dim i As Long
    For i = 1 To linesInCurrentOrder
        session.findById("wnd[1]").sendVKey KEY_ENTER
    Next i
...
Private Sub FillHeaderData(ByVal headerRow As Long)
    ...
    session.findById("wnd[0]/usr/tabsTAXI_TABSTRIP_HEAD/tabpT\13/ssubSUBSCREEN_BODY:SAPMV45A:4312/sub8309:SAPMV45A:8309/ctxtVBAK-ZZSTAKE_HOLDER").Text = ws.Cells(headerRow, COL_STAKE_HOLDER).Value
